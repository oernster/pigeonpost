// Package storage schema, steps 30 to 39: the body-cache clears, the message templates, the contact
// birthday and addresses, the keyset index, the snooze table and the search index's early shape. They
// sit apart from migrations.go only so each file stays within the module-size limit; the ordered list
