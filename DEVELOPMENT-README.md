...
internal/infrastructure/
    storage/                SQLite store (schema v42, migrations, outbox, rules, contacts, calendar, reminders, meeting scheduling, draft recovery, cached message attachments, CalDAV accounts, two-way calendar sync, full-text search index)
